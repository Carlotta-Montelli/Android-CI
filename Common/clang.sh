...
git clone "https://Carlotta-Montelli:$GH_TOKEN@github.com/Carlotta-Montelli/carlotta-clang-20" rel_repo
pushd rel_repo || exit
rm -fr ./*
cp -r ../install/* .
git lfs install
git lfs track "clang-20"
git lfs track "opt"
...
git lfs track "lld"
git lfs track "libclang.so.20.1.8"
git lfs track "libclang-cpp.so.20.1"
